...
const Schedule = () => {
  ...
  const scheduleData = [
    ...
    },
    {
      ...
      panelists: {
        chair: "Présidents : Maher GASSAB/ Adil BAMI/Foued GABSI/ Ines EL FARISSI/ Dhafer SAIDANE / Karim CHARAF/ Amine ISSAMI/ Nabil JEDLANE Karim KAMMOUN/ Jihane AAYALE/ Mariam SEFFAR/ Halima BAGHAD/ Meriam BOUYZEM/ Azzelarab ZAOUDI/ Imane BOUDRI/ Fouad MACHROUH",
      },
      special: {
